...
class TestPaymentReconciliation(FrappeTestCase):
	...
	def create_sales_invoice(
		self, qty=1, rate=100, posting_date=nowdate(), do_not_save=False, do_not_submit=False  # noqa
	):
		"""
	...
	def create_payment_entry(self, amount=100, posting_date=nowdate(), customer=None):  # noqa
		"""
